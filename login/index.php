                                    ...
                                    <div class="col-lg-9">
                                        <div>
                                            <div class="text-center">
                                                ...
                                                <h4 class="font-size-18 mt-4">Bem-vindos!</h4>
                                                <p class="text-muted">Login &lt;SyntaxWeb/></p>
                                            </div>

                                            <div class="p-2 mt-5">
                                                <form class="" method="post" action="./evrLogin.php">
                                                    <div class="mb-3 auth-form-group-custom mb-4">
                                                        <i class="ri-user-2-line auti-custom-input-icon"></i>
                                                        <label for="username">Usuário</label>
                                                        <input type="text" required class="form-control" name="usuario" 
                                                               id="username" placeholder="Digite o usuário">
                                                    </div>
                                                    ...
                                                    <div class="mb-3 auth-form-group-custom mb-4">
                                                        ...
                                                        <input type="password" class="form-control" required name="password" 
                                                               id="userpassword" placeholder="Digite a senha">
                                                    </div>

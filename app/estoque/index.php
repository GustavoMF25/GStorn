    ...
    <script>
        ...
        function alteraEstoque() {
            ...
            $.ajax({
                    ...
                    beforeSend: function() {
                        // Pode ser colocado um Loading
                        $("#produto_saida").html("ENVIANDO...");
                    }
                })
                .done(function(dados) {
                    $("#produto_saida").html(dados)
                })
                .fail(function(jqXHR, textStatus, msg) {
                    // alert(msg);
                    console.log(`Error -> ${msg}`)
                            ...
                            <div class="card-body">
                                <div class="tab-content" id="custom-tabs-three-tabContent">
                                    ...
                                    <div class="tab-pane fade" id="saida" role="tabpanel" aria-labelledby="saida-tab">
                                        <form method="post" autocomplete="off" action="./include/gProdutoEstoqueSaida.php">
                                            <div class='form-group'>
                                                <label for='estoque'><small><b> Estoque:</b></small></label>
                                                <select class="form-control select2" id="estoque_saida" onchange="alteraEstoque()" required style="width: 100%;" name="estoque">
                                                    <option value="">Selecione um estoque</option>
                                                    <?php
                                                    $queryEstoque = "select
                                                        id,
                                            ...
                                            <!-- <div class='form-group'>
                                                ...
                                                <select class="form-control select2" id="estoque" required style="width: 100%;" name="estoque">
                                                    <option value="">Selecione um estoque</option>
                                                    <option value="troca">Trocar estoque</option>
                                                    <option value="venda">Selecione um estoque</option>
                                                </select>
                                            </div> -->
                                            <div class='form-group'>
                                                <label for='produto'><small><b> Produto:</b></small></label>
                                                <select class="form-control select2" id="produto_saida" required style="width: 100%;" name="produto">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-12">
                        <div class="card card-success card-outline card-tabs">
                            ...
                            <div class="card-body">
                                ...
                                <div id="versaida" style="display: none;">
                                    <div class="text-center font-weight-bold">
                                        <span style="font-size: 18px;"> Seja bem vindo ao cadastro de usuarios! </span>
                                        <p style="font-size: 15px;"> Você está prestes a entrar em um mundo novo de gerenciamento de estoque e vai melhorar o desenpenho do seu negocio com essa nova ferramenta. </p>
                                    </div>
                                    <div class="d-flex justify-content-center">
                                        <lottie-player src="<?= BASE ?>/assets/animation/container.json" background="transparent" speed="1" style="width: 300px; height: 300px;" autoplay>
                                        </lottie-player>
                                    </div>
                                </div>
                            </div>
